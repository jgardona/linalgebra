...
# ╔═╡ 0d4d2900-86c9-11ee-1508-e32c74fd579b
using LinearAlgebra, Plots, Plots.PlotMeasures

# ╔═╡ 4b154f0d-5d60-40d3-a251-bfa9c0e048b4
md"""
# Least Squares
...
# ╔═╡ 05a96868-1249-4ef6-8454-1e322bc6fbb6
begin
	numcourses = [13,4,12,3,14,13,12,9,11,7,13,11,9,2,5,7,10,0,9,7]
	happiness  = [70,25,54,21,80,68,84,62,57,40,60,64,45,38,51,52,58,21,75,70]
end

# ╔═╡ 663b5ff6-ea17-4138-ae59-ba4e425166a8
let
	# build an statistical model with an intercept
	X = [ones(length(numcourses)) numcourses]
	beta = X \ happiness

	predictions = X * beta
	scatter(numcourses, happiness, label="Data", msw=0)
	scatter!(numcourses, predictions, label="Predictions", msw=0)
	xlabel!("Number of courses taken")
	p1 = ylabel!("General life happiness")

	for (n, y, yhat) in zip(numcourses, happiness, predictions)
		plot!(p1, [n, n], [y, yhat], label=:none, color=:gray, ls=:dash)
	end
	p1
end
